...
Die Luminosität gibt die Leistungsfähigkeit eines Teilchenbeschleunigers an und bezeichnet die Anzahl an Teilchenbegegnungen pro Zeit und Fläche. Durch Multiplikation von Luminosität und Wirkungsquerschnitt erhält man die Anzahl der Ereignisse des Prozesses pro Zeit, die im Teilchenbeschleuniger auftreten. \cite{povh}
...
Das Verzweigungsverhältnis $\mathrm{BR}$ ist gegeben durch:
\begin{align}
\mathrm{BR}_f&=\frac{\Gamma_f}{\Gamma_Z}
\end{align}
Für die Verzweigungsverhältnisse erhalten wir folgende Werte:
\begin{alignat}{3}
&\mathrm{BR}_l&&=&\,(10,3298\pm0,0013)\,\%\text{,}\\
&\mathrm{BR}_\nu&&=&(20,543\pm0,002)\,\%\text{,}\\
&\mathrm{BR}_q&&=&(69,123\pm0,010)\,\%\text{.}
\end{alignat}
...
\subsection{Teilchendetektoren \label{Teilchendetektor}}
